    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_sign_in.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String username_baru = username.getText().toString();
                final String password_baru = password.getText().toString();

                if(username_baru.isEmpty()){
                    Toast.makeText(getApplicationContext(),"Username kosong", Toast.LENGTH_SHORT).show();
                    //ubah state menjadi SIGN IN
                    btn_sign_in.setEnabled(true);
                    btn_sign_in.setText("SIGN IN");
                }else if(password_baru.isEmpty()){
                    ...
                    reference.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            if(dataSnapshot.exists()){
                                ...
                                //ambil ada password dari firebase
                                String passwordFromFirebase = dataSnapshot.child("password").getValue().toString();

                                //validasi password dengan password firebase
                                if(password_baru.equals(passwordFromFirebase)){
