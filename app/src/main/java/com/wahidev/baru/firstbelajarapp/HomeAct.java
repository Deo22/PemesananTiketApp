...
public class HomeAct extends AppCompatActivity {
    ...
    LinearLayout btn_ticket_pisa, btn_ticket_pagoda, btn_ticket_sphinx,
            btn_ticket_candi, btn_ticket_torri, btn_ticket_monas;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_ticket_pisa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent gotopisatiket = new Intent(HomeAct.this, TiketDetailAct.class);
        ...
        btn_ticket_torri.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent gotopisatiket = new Intent(HomeAct.this, TiketDetailAct.class);
                gotopisatiket.putExtra("jenis_tiket", "Torri");
                startActivity(gotopisatiket);
            }
        });
